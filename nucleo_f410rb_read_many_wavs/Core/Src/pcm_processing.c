...
// Extern variables
extern uint32_t data_bytes_read;
extern uint8_t bufr[8192];
extern uint32_t data_size_dec;
extern FRESULT res;
extern FIL file;
extern UINT br;
extern uint16_t block_align_dec;
extern uint16_t bytes_per_sample_dec;
extern uint32_t ccr_l[2048];
extern uint32_t ccr_r[2048];
extern uint32_t skip_data;
...
uint32_t pcm_to_ccr(int32_t pcm_amp, const uint32_t ARR,
